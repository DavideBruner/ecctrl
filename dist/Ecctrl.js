  ...
  /* @__PURE__ */ subscribeWithSelector((set, get) => {
    return {
      ...
      idle: () => {
        set((state) => {
          ...
          if (state.curAnimation === state.animationSet.jumpIdle) {
            ...
            if (((_a = state.animationSet) == null ? void 0 : _a.custom) && Object.values((_b = state.animationSet) == null ? void 0 : _b.custom).includes(
              state.curAnimation
            )) {
              return {};
            }
      ...
      setCustomAnimation: (animation) => {
        set((state) => {
          if (state.animationSet.custom[animation] && state.curAnimation === state.animationSet.idle) {
